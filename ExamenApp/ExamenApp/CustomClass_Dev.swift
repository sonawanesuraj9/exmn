...
class CustomClass_Dev: NSObject {
    ...
    let placeholderTextColor : UIColor = UIColor(red: 0/255, green: 73/255, blue: 126/255, alpha: 0.6)
...
//    
    let FontName : String = "Quicksand-Regular"
    ...
    let textTintColor : UIColor = UIColor(red: 66/255, green: 110/255, blue: 216/255, alpha: 1.0)
    //Validate EmailID
    ...
    func isValidUrl(candidate: String) -> Bool {
        var urlRegEx: String = "(http|https)://((\\w)*|([0-9]*)|([-|_])*)+([\\.|/]((\\w)*|([0-9]*)|([-|_])*))+"
        var urlTest: NSPredicate = NSPredicate(format: "SELF MATCHES %@", urlRegEx)
